    ...
    <main class="main-content">
        ...
        <div class="note-item">
            <div class="note-info">
                ...
                <div>
                    <a href="{{ route('notes.show', $note->id) }}" class="note-details">
            ...
            <div class="btn-group">
              <a href="{{ route('note.edit', $note->id) }}" class="btn-edit">Edit</a>
        ...
        <div class="list">
            <form action="{{ route('notes.deleteAll') }}" method="POST" style="display:inline;">
                    @csrf
                <button type="submit" class="btn-num">Delete All</button>
            </form>
        </div>
    </main>
</body>
